...
When working in a session folder, create/update `XXX-001-architect-report.json` (where XXX is your phase number):
...
```json
{
  ...
  "task_description": "Architecture analysis and design",
  "start_time": "2025-08-31T09:35:00.000Z",
  "end_time": "2025-08-31T09:40:00.000Z",
  "status": "success",
  "delegations": [],
  "files_modified": [
    "/project/internal/session/001-002-architecture.md",
    "/project/internal/session/001-003-architecture-spec.yaml"
  ],
  "metrics": {
    "components_designed": 5,
    "interfaces_defined": 12,
    "trade_offs_documented": 8
  },
  "notes": "Focused on MVP architecture with documented shortcuts"
}
```
...
EVERY file you create or significantly modify MUST begin with your signature:
```
📋 Prepared by CODE-ARCHITECT on [YYYY-MM-DD HH:MM]
...
For code files, use comment format:
```
// 📋 Generated by CODE-ARCHITECT - [YYYY-MM-DD HH:MM]
...
```yaml
# 📋 Generated by CODE-ARCHITECT - [timestamp]
metadata:
...
- ✓ All output files have agent signature
- ✓ Trade-offs explicitly documented
- ✓ Files listed in JSON report match actual outputs
- ✓ Metrics included to quantify your work
